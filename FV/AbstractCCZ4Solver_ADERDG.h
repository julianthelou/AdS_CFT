...
class CCZ4::AbstractCCZ4Solver_ADERDG: public exahype::solvers::ADERDGSolver {
public:
  static constexpr int Order                     = 3;
  static constexpr int NumberOfVariables         = 63;
  static constexpr int NumberOfParameters        = 0;
  static constexpr int NumberOfGlobalObservables = 0;
  static constexpr int NumberOfDMPObservables    = -1; // only of interest if this ADERDGSolver is a component of a LimitingADERDSolver 
